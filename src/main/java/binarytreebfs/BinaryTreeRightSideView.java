...
public class BinaryTreeRightSideView {
    ...
    /**
     * Given a binary tree, imagine you are standing on the right side of it. Return a list containing the elements you
     * can see from here, from top to bottom.
     * I know that this problem is supposed to be a BFS problem, but my first idea was a solution using DFS, so I'll
     * try implementing that first.
     * Do a DFS traversal, visiting the right subtree, then root, then left subtree, and keep track of which level
     * we're on and if we have seen any elements on this level yet
     *
     ...
     * Given a binary tree, imagine you are standing on the right side of it. Return a list containing the elements you
     * can see from here, from top to bottom.
     * Since this is supposed to be a BFS problem, solve it in a different way.
     * Visit one level at a time. At each level, the visible element will be the one furthest to the right.
     *
     * @param root the root node of the binary tree
     * @return the elements of the binary tree visible from the right, from top to bottom
     */
    ...
    public static void main(String[] args) {
        ...
        TreeNode binaryTree =
                new TreeNode(1,
                    ...
                    null,
                        new TreeNode(4)));
        System.out.printf("Binary tree (rotated counter-clockwise):\n%s\nElements seen from the right:\n%s\n\n",
